...
Obtener los ficheros necesitará una dosis de **Bureaucracy**, **Cop talk** o **Research**

- Hace nueve años hubo una serie de robos todos con el mismo modus operandi
- Todos los objetivos eran de gran valor: joyerias, bancos, residencias privadas de ricos. Todos tenían algun tipo de sistema electrónico.
- En cada caso, los sistemas de seguridad fallaban misteriosamente. Cámaras apagadas, alarmas que no se disparan, puertas electrónicas que se desbloquean solas.
...
- Tras varios robos exitosos los guardias fueron interrumpidos por un guardia de seguridad que acabó sufriendo los daños de un fogonazo y quedó aturdido. Los ladrones huyeron. El guardia de seguridad vio al menos 2 personas huyendo y con esto finalizó la serie de robos
    - **Energie Residue Analysis** Sugiere que el ataque era de [Fire projection](../anexo/poderes.md#fire-projection). Las técnicas para averiguar esta información fueron desarrolladas mucho mas tarde. Por suerte la pistola semifundida está en una bolsa de plástico entre las pruebas del caso. No hay ninguna coincidencia en el archivo pero con una muestra de [Lynn Parsons](all-fired-up.md). Coincide!